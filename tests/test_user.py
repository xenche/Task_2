...
from utils.helpers import generate_user_data, generate_unique_email, generate_unique_name
...
class TestUserRegistration:
    ...
    def test_create_existing_user(self, registered_user):
        email, password, name, _ = registered_user
        response = UserAPI.register(email, password, name)
...
class TestUserUpdate:
    ...
    def test_update_user_name_with_authorization(self, registered_user):
        email, password, name, access_token = registered_user
    ...
    def test_update_user_email_with_authorization(self, registered_user):
        email, password, name, access_token = registered_user
    ...
    def test_update_user_name_without_authorization(self, registered_user):
        email, password, name, access_token = registered_user
        new_name = generate_unique_name()
    ...
    def test_update_user_email_without_authorization(self, registered_user):
        email, password, name, access_token = registered_user
        new_email = generate_unique_email()
